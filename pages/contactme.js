...
export default function Contact() {
  ...
  return (
    <div className=" bg-dark-bg z-0 ">
      ...
      <main className="h-screen  text-center overflow-hidden">
        ...
        <div className=" absolute  w-screen z-50 mt-10  ">
          ...
          <form className="" onSubmit={sendEmail}
            ...
            <input
              type="submit"
              value="Send Message"
              class="transition duration-300 ease-in-out bg-transparent hover:bg-yellow-500 text-yellow-600 font-semibold hover:text-white  border border-yellow-600 hover:border-transparent rounded-sm mt-6 text-2xl lg:4xl cursor-pointer w-3/4 mx-auto bg-gray-800 py-2">
            </input>
          </form>
