...
const Projects = () => {
    return (
        <div className="grid  md:grid-cols-2  gap-x-3  ">
            {projects.map((p, i) => {
                return (
                    <div className="place-items-center my-5 container   bg-gray-800 hover:bg-gray-700 rounded-lg border border-black">
                        <img
                        src={p.image} className=" w-full z-0  rounded-t-lg" />
